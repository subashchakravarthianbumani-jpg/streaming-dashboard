...
class _ProfileViewState extends State<ProfileView> with WidgetsBindingObserver {
  ...
  Widget _buildProfileElements(BoxConstraints constraints, bool isDarkMode) {
    ...
    final fieldHeight = isLargeScreen
        ? 50.0
        : isTablet
        ? 45.0
        : 40.0;
    final fontSize = isLargeScreen
        ...
        ? 17.0
        : 14.0;
    final labelFontSize = isLargeScreen
        ? 17.0
        : isTablet
        ? 16.0
        : 14.0;
      ...
      child: Column(
        ...
        children: [
          buildTextFieldCommon(
            ...
            required: true,
            hint: AppStrings.ksEnterFirstName,
          ...
          buildTextFieldCommon(
            ...
            required: true,
            hint: AppStrings.ksEnterLastName,
            keyboardType: TextInputType.text,
            height: fieldHeight,
            fontSize: fontSize,
            labelFontSize: labelFontSize,
          ...
          buildTextFieldCommon(
            ...
            required: true,
            hint: AppStrings.ksEnterPhoneNumber,
          ...
          buildTextFieldCommon(
            ...
            required: true,
            hint: AppStrings.ksEnterUserGroupName,
            keyboardType: TextInputType.text,
            height: fieldHeight,
            fontSize: fontSize,
            labelFontSize: labelFontSize,
          ...
          buildTextFieldCommon(
            ...
            required: true,
            hint: AppStrings.ksEnterRoleName,
            keyboardType: TextInputType.text,
            height: fieldHeight,
            fontSize: fontSize,
            labelFontSize: labelFontSize,
